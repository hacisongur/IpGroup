...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager:ICategoryService
    {
        ...
        public async Task<IDataResult<int>> GetCategoryCountByBinaAsync(string bina)
        {
            var categories = await _unitOfWork.Categories.GetAllAsync(c => c.Bina == bina && !c.IsDeleted);
            return new DataResult<int>(ResultStatus.Success, categories.Count);
        }
    }
}
